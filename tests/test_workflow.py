...
def test_event_bus():
    """测试事件总线"""
    from tianlong_salesmaster.core.workflow import EventBus, WorkflowEvent, EventType
...
def test_workflow_creation():
    """测试工作流创建"""
    from tianlong_salesmaster.core.workflow import Workflow, WorkflowStep, StepStatus
...
def test_workflow_engine():
    """测试工作流引擎"""
    from tianlong_salesmaster.core.workflow.engine import WorkflowEngine, get_workflow_engine
...
def test_workflow_execution():
    """测试工作流执行"""
    from tianlong_salesmaster.core.workflow.engine import get_workflow_engine
    from tianlong_salesmaster.core.workflow import FlowStatus, StepStatus
...
def test_workflow_event_publishing():
    """测试工作流事件发布"""
    from tianlong_salesmaster.core.workflow import get_event_bus, EventType, WorkflowEvent
...
def test_workflow_templates():
    """测试工作流模板"""
    from tianlong_salesmaster.core.workflow.engine import get_workflow_engine
    from tianlong_salesmaster.core.workflow import EventType
