...
# 测试智能寻客模块
print("=== 智能寻客测试 ===")
from tianlong_salesmaster.lead_gen.data_mining import get_data_mining_service
...
# 测试线索评分模块
print("\n=== 线索评分测试 ===")
from tianlong_salesmaster.lead_gen.scoring import get_lead_scoring_service, LeadInfo
...
# 测试企微通信模块
print("\n=== 企微通信测试 ===")
from tianlong_salesmaster.followup.communication import get_communication_service, ChannelType
...
# 测试销售预测模块
print("\n=== 销售预测测试 ===")
from tianlong_salesmaster.prediction.ai_model import get_sales_prediction_service, Deal, DealStage
