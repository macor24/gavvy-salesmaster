"""gavvy_salesmaster.core.enterprise_client — 企业版 SaaS API 客户端
...
API Key 检测链：SENTRIKIT_API_KEY > SENTRIKIT_API_KEY > 配置文件
"""
...
try:
    from sentrikit.enterprise_client import (
        SentriKitEnterprise,
...
def detect_api_key() -> str:
    ...
    if key:
        return key
    return os.environ.get("SENTRIKIT_API_KEY", "")
